...
def cli_main():
    ...
    parser.add_argument("--logs_name", type=str, default="human_to_anime")
    parser.add_argument(
        "--checkpoints_dir", type=str, default="checkpoints/human_to_anime"
    )

    parser.add_argument(
        "--checkpoint_filename",
        type=str,
        default="human_to_anime_{epoch:.2f}_{G_loss:.2f}",
    )
    parser = LitGAN.add_model_specific_args(parser)
